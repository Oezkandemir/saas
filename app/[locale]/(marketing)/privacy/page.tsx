      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          <section className="space-y-4">
            ...
            <p>
              At Cenety, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, 
              and safeguard your information when you visit our website or use our services. Please read this policy 
              carefully. By accessing or using our services, you acknowledge that you have read and understood this 
              Privacy Policy.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              <strong>Personal Information:</strong> This may include your name, email address, phone number, billing 
              address, and payment information.
            </p>
            <p>
              <strong>Usage Data:</strong> We may also collect information about how the services are accessed and 
              used. This data may include your computer&apos;s Internet Protocol address, browser type, browser version, 
              pages visited, time and date of visit, time spent on those pages, and other diagnostic data.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              We implement appropriate technical and organizational safeguards to protect the security of your personal 
          ...
          <section className="space-y-4">
            ...
            <p>
              If you have any questions about this Privacy Policy, please contact us at privacy@cenety.com.
            </p>
          </section>
        </div>
      </div>
