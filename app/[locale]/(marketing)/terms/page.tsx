      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          <section className="space-y-4">
            ...
            <p>
              Welcome to Cenety. These Terms of Service (&quot;Terms&quot;) govern your use of the Cenety website, 
              platform, and services (collectively, the &quot;Services&quot;). By accessing or using our Services, 
              you agree to be bound by these Terms. If you disagree with any part of the Terms, you do not have 
          ...
          <section className="space-y-4">
            ...
            <p>
              <strong>&quot;Content&quot;</strong> means any text, images, graphics, videos, or other material 
              that you upload, post, or otherwise make available through the Services.
            </p>
            <p>
              <strong>&quot;User&quot;</strong> means any individual who accesses or uses the Services.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              or actions under your Account. We encourage you to use a strong password and to sign out of your Account at 
          ...
          <section className="space-y-4">
            ...
            <p>
              The Services and their original content, features, and functionality are owned by Cenety and are protected 
          ...
          <section className="space-y-4">
            ...
            <p>
              You retain all rights to any Content that you submit, post, or display on or through the Services. By 
          ...
          <section className="space-y-4">
            ...
            <p>
              We reserve the right to terminate or suspend your Account and access to the Services, without prior notice 
          ...
          <section className="space-y-4">
            ...
            <p>
              In no event shall Cenety, its directors, employees, partners, agents, suppliers, or affiliates be liable 
          ...
          <section className="space-y-4">
            ...
            <p>
              If you have any questions about these Terms, please contact us at terms@cenety.com.
            </p>
          </section>
        </div>
      </div>
