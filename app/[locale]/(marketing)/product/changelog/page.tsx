  ...
  const releases = [
    {
      ...
      description: "A complete rebuild with Next.js 15, improved UI, and enhanced features",
      changes: [
        { type: "feature", desc: "Upgraded to Next.js 15 with improved performance" },
        { type: "feature", desc: "Added Supabase integration for more flexible database operations" },
        { type: "feature", desc: "Implemented Next-Intl for better internationalization support" },
        { type: "feature", desc: "Added Contentlayer for improved content management" },
        { type: "improvement", desc: "Redesigned dashboard with better user experience" },
        { type: "improvement", desc: "Enhanced Stripe integration with more payment options" },
        { type: "fix", desc: "Fixed authentication issues with email providers" },
        { type: "fix", desc: "Resolved styling inconsistencies across different browsers" }
      ]
    },
    {
      version: "1.5.0",
                ...
                <div key={changeIndex} className="flex items-start gap-2">
                  <Badge 
                    variant={
                      ...
                      change.type === "improvement" ? "secondary" : 
                      "outline"
                    }
