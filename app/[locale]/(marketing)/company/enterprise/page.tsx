...
export default async function EnterprisePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold">Why Choose Cenety Enterprise?</h2>
        <p>
          Our enterprise solutions provide the reliability, security, and scalability that businesses need
          to succeed in today&apos;s fast-paced digital landscape. With dedicated support, custom development options,
          and advanced features, Cenety Enterprise helps your organization build better software faster.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>24/7 priority access to our support team</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="rounded-lg bg-muted p-8 text-center">
        ...
        <p className="mb-6">
          Contact our sales team to discuss your enterprise requirements and how we can help.
        </p>
