...
export default async function TicketPage({
  ...
  const createdAt = formatDistance(new Date(ticket.created_at), new Date(), { addSuffix: true });
  const updatedAt = formatDistance(new Date(ticket.updated_at), new Date(), { addSuffix: true });
        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <CardDescription>{t("created")} {createdAt}</CardDescription>
            </div>
