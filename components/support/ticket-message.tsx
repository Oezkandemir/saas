...
export function TicketMessageItem({ message, isCurrentUser }: TicketMessageProps) {
    ...
    <div className={cn(
      ...
      {(!isCurrentUser || isAdmin) && (
        <Avatar className="size-8">
          <AvatarImage src={`https://avatar.vercel.sh/${message.user_id}.png`} alt={userName} />
      ...
      <div className={cn(
        ...
        <div className="mb-1 flex items-center gap-2">
          ...
          {isAdmin && (
            <Badge variant="outline" className="flex h-5 items-center gap-1 py-0 text-xs">
