...
export function TeamPermissions({ teamId, userRole }: TeamPermissionsProps) {
  ...
  const permissions = [
    {
      id: "view_team",
      name: t("permissions.viewTeam.name"),
      description: t("permissions.viewTeam.description"),
    },
    {
      id: "invite_members",
      name: t("permissions.inviteMembers.name"),
      description: t("permissions.inviteMembers.description"),
    },
    {
      id: "manage_members",
      name: t("permissions.manageMembers.name"),
      description: t("permissions.manageMembers.description"),
    },
    {
      id: "remove_members",
      name: t("permissions.removeMembers.name"),
      description: t("permissions.removeMembers.description"),
    },
    {
      id: "update_team",
      name: t("permissions.updateTeam.name"),
      description: t("permissions.updateTeam.description"),
    },
    {
      id: "delete_team",
      name: t("permissions.deleteTeam.name"),
      description: t("permissions.deleteTeam.description"),
    },
  ];
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>{t("teamPermissions.description")}</CardDescription>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
