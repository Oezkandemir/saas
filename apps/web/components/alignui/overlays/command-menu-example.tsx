...
export function CommandMenuExample({
  ...
  return (
    <>
      {/* Trigger Button - kann überall platziert werden */}
      <Button
        variant="outline"
        onClick={() => setOpen(true)}
        className="relative h-9 w-full justify-start rounded-md bg-muted/50 text-sm font-normal text-muted-foreground shadow-none pr-12 sm:w-64"
      >
