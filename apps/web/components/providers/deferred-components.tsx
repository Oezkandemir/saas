...
const TailwindIndicator = dynamic(
  () =>
    import("@/components/tailwind-indicator").then((mod) => ({
      default: mod.TailwindIndicator,
    })),
  {
    ssr: false,
  }
...
const PerformanceTracker = dynamic(
  () =>
    import("@/components/performance-tracker").then((mod) => ({
      default: mod.PerformanceTracker,
    })),
  {
    ssr: false,
  }
...
const AutoRefreshSubscription = dynamic(
  () =>
    import("@/components/pricing/auto-refresh-subscription").then((mod) => ({
      default: mod.AutoRefreshSubscription,
    })),
  {
    ssr: false,
  }
