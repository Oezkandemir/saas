      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <TabsContent value="overview" className="space-y-6 mt-6">
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-base">
                  {t("availability.title") || "Timing Settings"}
                </CardTitle>
              </CardHeader>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-sm font-semibold">
                {t("bookings.upcoming") || "Upcoming Bookings"}
              </h3>
              <p className="text-xs text-muted-foreground mt-1">
                {t("bookings.upcomingDescription") ||
                  `${upcomingBookings.length} scheduled bookings`}
              </p>
            </div>
          </div>
                    ...
                    {upcomingBookings.map((booking) => (
                      <TableRow key={booking.id}>
                        ...
                        <TableCell className="text-right">
                          <Link
                            href={`/dashboard/scheduling/bookings/${booking.id}`}
                          >
                            <Button
                              variant="ghost"
                              size="sm"
        ...
        <TabsContent value="settings" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">
                {t("settings.title") || "Event Type Settings"}
              </CardTitle>
              <CardDescription>
                {t("settings.description") ||
                  "Manage your event type configuration"}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-sm font-medium mb-2">
                    {t("settings.lastUpdated") || "Last Updated"}
                  </p>
                  <p className="text-xs text-muted-foreground">
        ...
        <TabsContent value="share" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">
                {t("share.title") || "Share Your Booking Page"}
              </CardTitle>
              <CardDescription>
                {t("share.description") ||
                  "Share this link to allow people to book this event type"}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <p className="text-sm font-medium">
                  {t("share.bookingUrl") || "Booking URL"}
                </p>
                <div className="flex items-center gap-2">
                  <Input
                    value={bookingUrl}
