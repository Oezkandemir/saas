...
export default async function AdminEmailsDebugPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      <h1 className="text-3xl font-bold mb-6">Email Webhook Configuration Debug</h1>
      ...
      <div className="space-y-6">
        <div className="border rounded-lg p-6 bg-card">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b">
              ...
              <span className={checks.resendApiKey ? "text-green-600" : "text-red-600"}>
            ...
            <div className="flex justify-between items-center py-2 border-b">
              ...
              <span className={checks.hasServiceRoleKey ? "text-green-600" : "text-red-600"}>
          ...
          <div className="space-y-3">
            ...
            <div className="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded">
              ...
              <ol className="list-decimal list-inside space-y-2 text-sm text-yellow-700 dark:text-yellow-300">
                ...
                <li>Match pattern: Use "*@cenety.com" or specific email like "support@cenety.com"</li>
        ...
        <div className="border rounded-lg p-6 bg-card">
          ...
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground mb-4">
              For inbound emails, you need an MX record pointing to Resend's mail servers:
            </p>
            <div className="bg-muted p-4 rounded space-y-2 font-mono text-sm">
              ...
              <div>
                <span className="font-semibold">Name:</span> @ (or your subdomain)
              </div>
              <div>
                <span className="font-semibold">Value:</span> feedback-smtp.resend.com
              </div>
              <div>
            ...
            <p className="text-xs text-muted-foreground mt-4">
              Note: Check your Resend domain settings for the exact MX records you need.
            </p>
          </div>
        </div>
        ...
        <div className="border rounded-lg p-6 bg-card">
          ...
          <div className="space-y-3">
            <div>
              <p className="font-medium mb-2">1. Health Check (Detailed Status):</p>
              <a 
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Returns detailed JSON with all configuration checks and database connectivity
              </p>
            </div>
            <div className="mt-4">
              <p className="font-medium mb-2">2. Test Webhook Endpoint (GET):</p>
              <a 
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Should return: {`{"message":"Resend Inbound Email Webhook Endpoint","status":"active"}`}
              </p>
            </div>
            <div className="mt-4">
              <p className="font-medium mb-2">3. Send Test Email:</p>
              <p className="text-sm text-muted-foreground">
                Send an email to your configured inbound address (e.g., support@cenety.com)
                from an external email account. Check the admin emails page to see if it appears.
              </p>
            </div>
            <div className="mt-4">
              <p className="font-medium mb-2">4. Check Resend Logs:</p>
              <p className="text-sm text-muted-foreground">
                Go to <a href="https://resend.com/logs" target="_blank" rel="noopener noreferrer" className="underline text-blue-600">
                  Resend Logs
                </a> to see webhook delivery attempts and any errors.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border rounded-lg p-6 bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800">
          ...
          <ul className="space-y-2 text-sm text-red-700 dark:text-red-300">
            <li>
              <strong>1. Webhook URL mismatch:</strong> Make sure the webhook URL in Resend matches your production domain exactly
            </li>
            <li>
              <strong>2. Missing MX records:</strong> DNS must have MX records pointing to Resend's servers
            </li>
            <li>
              <strong>3. Route not enabled:</strong> Check that the inbound route is enabled in Resend dashboard
            </li>
            <li>
              <strong>4. Email pattern mismatch:</strong> The "from" pattern in Resend route must match incoming emails
            </li>
            <li>
              <strong>5. Environment variables:</strong> Make sure RESEND_API_KEY and other vars are set in production
            </li>
            <li>
              <strong>6. Supabase connection:</strong> Check that Supabase credentials are correct in production
            </li>
            <li>
              <strong>7. Function timeout:</strong> Vercel serverless functions have a 10s timeout by default
            </li>
          </ul>
        </div>
      </div>
