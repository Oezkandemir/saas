 ...
 */
export async function getCompanyProfiles(): Promise<
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      company_registration_number:
        input.company_registration_number?.trim() || null,
      ...
      // Document defaults
      default_tax_rate: input.default_tax_rate ?? 19.0,
...
export async function updateCompanyProfile(
  ...
  if (input.company_address_line2 !== undefined)
    updateData.company_address_line2 =
      input.company_address_line2?.trim() || null;
  ...
  if (input.company_registration_number !== undefined)
    updateData.company_registration_number =
      input.company_registration_number?.trim() || null;
  ...
  if (input.contact_person_position !== undefined)
    updateData.contact_person_position =
      input.contact_person_position?.trim() || null;
  ...
  if (input.iban !== undefined) updateData.iban = input.iban?.trim() || null;
  if (input.bic !== undefined) updateData.bic = input.bic?.trim() || null;
