      ...
      <Body className="bg-white font-sans">
        <Container className="mx-auto py-5 pb-12">
          ...
          <Text className="text-base">
            Thanks for signing up for {siteName}! To complete your registration and verify your email address, please click the button below:
          </Text>
          ...
          <Text className="text-base">
            If you did not create an account with {siteName}, you can safely ignore this email.
          </Text>
